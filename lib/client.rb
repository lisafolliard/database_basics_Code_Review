...
class Client
  attr_reader(:firstname, :lastname, :stylist_id, :id)
  ...
  define_method(:save) do
    result_set = DB.exec("INSERT INTO clients (firstname, lastname, stylist_id) VALUES ('#{@firstname}', '#{@lastname}', '#{@stylist_id}') RETURNING id;")
